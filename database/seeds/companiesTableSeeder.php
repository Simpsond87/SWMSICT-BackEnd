...
class companiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('companies')->insert([
            ...
            'image' => 'http://localhost:8000/photos/logo-Vanguard.jpg',
      ]);
      DB::table('companies')->insert([
            'name' => 'Charles Schwab',
            ...
            'image' => 'http://localhost:8000/photos/logo-CharlesSchwab.png',
      ]);
      DB::table('companies')->insert([
        'name' => 'Ameritrade',
        ...
        'image' => 'http://localhost:8000/photos/logo-Ameritrade.jpg',
      ]);
      DB::table('companies')->insert([
            ...
            'image' => 'http://localhost:8000/photos/logo-iShares.jpg',
      ]);
      DB::table('companies')->insert([
        'name' => 'Voya',
        ...
        'image' => 'http://localhost:8000/photos/logo-Voya.png'
      ]);
  }
}
